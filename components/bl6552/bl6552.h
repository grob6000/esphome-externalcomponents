...
// The BL6552 IC is "calibration-free", which means that it doesn't care
...
// to calculate BL6552_UREF and BL6552_IREF. Those are in units of
// "305978 counts per amp" or "73989 counts per volt" respectively.
//
// We can derive BL6552_PREF from those. Let's eliminate the weird
...
// BL6552_PREF = BL6552_UREF * BL6552_IREF * 3537 / 305978 / 73989.
//
...
// Factoring in the calibration, that's 419230.4 / BL6552_PREF actual
...
// CF_CNT * 419230.4 / BL6552_PREF / 3600000
//
// Which makes BL0952_EREF = BL6552_PREF * 3600000 / 419430.4

static const float BL6552_PREF = 596;              // taken from tasmota
static const float BL6552_UREF = 15873.35944299;   // should be 73989/1.218
static const float BL6552_IREF = 251213.46469622;  // 305978/1.218
static const float BL6552_EREF = 3304.61127328;    // Measured
...
class BL6552 : public PollingComponent, public uart::UARTDevice {
 ...
 protected:
  ...
  float power_reference_ = BL6552_PREF;
  bool power_reference_set_ = false;
  // Divide by this to turn into Volt
  float voltage_reference_ = BL6552_UREF;
  bool voltage_reference_set_ = false;
  // Divide by this to turn into Ampere
  float current_reference_ = BL6552_IREF;
  bool current_reference_set_ = false;
  // Divide by this to turn into kWh
  float energy_reference_ = BL6552_EREF;
